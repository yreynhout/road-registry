namespace RoadRegistry.BackOffice.Api.ZipArchiveWriters.ForProduct
{
    ...
    public class RoadSegmentNumberedRoadAttributesToZipArchiveWriter : IZipArchivePathWriter<ProductContext>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var dbfEntry = archive.CreateEntry(path.Combine("AttGenumweg.dbf"));
