namespace RoadRegistry.BackOffice.Api.ZipArchiveWriters.ForProduct
{
    ...
    public class RoadSegmentSurfaceAttributesToZipArchiveWriter : IZipArchivePathWriter<ProductContext>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var dbfEntry = archive.CreateEntry(path.Combine("AttWegverharding.dbf"));
