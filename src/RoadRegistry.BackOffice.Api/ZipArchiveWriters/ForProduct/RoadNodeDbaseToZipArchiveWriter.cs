namespace RoadRegistry.BackOffice.Api.ZipArchiveWriters.ForProduct
{
    ...
    public class RoadNodeDbaseToZipArchiveWriter : IZipArchivePathWriter<ProductContext>
    {
        private readonly RecyclableMemoryStreamManager _manager;
        private readonly Encoding _encoding;

        public RoadNodeDbaseToZipArchiveWriter(RecyclableMemoryStreamManager manager, Encoding encoding)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var dbfEntry = archive.CreateEntry(path.Combine("Wegknoop.dbf"));
