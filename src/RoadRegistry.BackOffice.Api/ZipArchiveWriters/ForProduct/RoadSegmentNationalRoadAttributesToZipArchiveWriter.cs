namespace RoadRegistry.BackOffice.Api.ZipArchiveWriters.ForProduct
{
    ...
    public class RoadSegmentNationalRoadAttributesToZipArchiveWriter : IZipArchivePathWriter<ProductContext>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var dbfEntry = archive.CreateEntry(path.Combine("AttNationweg.dbf"));
