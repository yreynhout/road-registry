namespace RoadRegistry.BackOffice.Api.ZipArchiveWriters.ForProduct
{
    ...
    public class RoadSegmentDbaseToZipArchiveWriter : IZipArchivePathWriter<ProductContext>
    {
        private readonly RecyclableMemoryStreamManager _manager;
        private readonly Encoding _encoding;

        public RoadSegmentDbaseToZipArchiveWriter(RecyclableMemoryStreamManager manager, Encoding encoding)
        {
