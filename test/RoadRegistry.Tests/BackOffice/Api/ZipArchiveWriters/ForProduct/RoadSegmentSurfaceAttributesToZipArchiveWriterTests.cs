namespace RoadRegistry.BackOffice.Api.ZipArchiveWriters.ForProduct
{
    ...
    public class RoadSegmentSurfaceAttributesToZipArchiveWriterTests
    {
        ...
        public RoadSegmentSurfaceAttributesToZipArchiveWriterTests(SqlServer fixture)
        {
        ...
        {
            var sut = new RoadSegmentSurfaceAttributesToZipArchiveWriter(_fixture.MemoryStreamManager,  Encoding.UTF8);
